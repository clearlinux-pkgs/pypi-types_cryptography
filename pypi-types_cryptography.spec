...
Version  : 3.3.20
Release  : 10
URL      : https://files.pythonhosted.org/packages/7e/6d/3e60156e64dc7f010e153a2a187751e2aa336892bfba54ecbd98d2e714ba/types-cryptography-3.3.20.tar.gz
Source0  : https://files.pythonhosted.org/packages/7e/6d/3e60156e64dc7f010e153a2a187751e2aa336892bfba54ecbd98d2e714ba/types-cryptography-3.3.20.tar.gz
...
%prep
%setup -q -n types-cryptography-3.3.20
cd %{_builddir}/types-cryptography-3.3.20
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650295168
