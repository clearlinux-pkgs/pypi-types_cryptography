...
Source0  : https://files.pythonhosted.org/packages/f7/e6/8000a96058bd9e32a8858a82c7e519ac0032e571e634aa684a2f5444477b/types-cryptography-3.3.19.tar.gz
...
%prep
%setup -q -n types-cryptography-3.3.19
cd %{_builddir}/types-cryptography-3.3.19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649172604
