...
Version  : 3.3.23.1
Release  : 21
URL      : https://files.pythonhosted.org/packages/ca/c3/8899107a7018bd60802c1ddee1800b0fd5676891a50026fcabd941cb70bc/types-cryptography-3.3.23.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ca/c3/8899107a7018bd60802c1ddee1800b0fd5676891a50026fcabd941cb70bc/types-cryptography-3.3.23.1.tar.gz
...
%prep
%setup -q -n types-cryptography-3.3.23.1
cd %{_builddir}/types-cryptography-3.3.23.1
pushd ..
cp -a types-cryptography-3.3.23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666020652
