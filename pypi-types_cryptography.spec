...
Version  : 3.3.23.2
Release  : 23
URL      : https://files.pythonhosted.org/packages/18/05/a57fe8bbed10fe4b739fac6e16c4e80c5199ce2f74ae67fa7d7f6e3750da/types-cryptography-3.3.23.2.tar.gz
...
%prep
%setup -q -n types-cryptography-3.3.23.2
cd %{_builddir}/types-cryptography-3.3.23.2
pushd ..
cp -a types-cryptography-3.3.23.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667958244
