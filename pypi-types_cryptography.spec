...
Source0  : https://files.pythonhosted.org/packages/14/a1/d542b5c8253a6a5b45f7de52373fd73de3dae545e4eb70580a36f59d8014/types-cryptography-3.3.18.tar.gz
...
%prep
%setup -q -n types-cryptography-3.3.18
cd %{_builddir}/types-cryptography-3.3.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646929631
